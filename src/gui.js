...
import {
  ...
  Animation, BoxMorph, ZERO, BLACK, isString, CursorMorph, sizeOf
} from './morphic'
...
import {
  ...
  PrototypeHatBlockMorph, CustomReporterBlockMorph, CustomBlockDefinition
} from './byob'
...
BlockEditorMorph.prototype.context = function (prototypeHat) {
  ...
  console.log("process: ", Process.prototype);
