...
*/
export var SchemeNumber = (function() {

//
// Multiple dispatch support.
//

export var DispatchJs = (function() {
"use strict";
/*
...
export var ret = makeContext(Object.create(null));
...
*/
export function PluginContainer(init) {
    "use strict";
...
export function assert(x) { if (!x) throw new Error("assertion failed"); }

export function getEs5Globals() {
...
export function implementUncurry(plugins) {
...
export function defineGenericFunctions(plugins) {
    "use strict";
    var g = plugins.get("es5globals");
...
export function defineSchemeNumberType(plugins) {
    "use strict";
    var g = plugins.get("es5globals");
    var _NaN = g.NaN;
    var api = g.Object.create(null);
...
/*
    ...
    *plugins* shall be a <PluginContainer> containing the following
    ...
    See Also: <JsDispatch>
*/
export function defineDebugFunction(plugins) {
    "use strict";
    var g                = plugins.get("es5globals");
...
*/
export function implementCoreLibrary(plugins) {
    "use strict";
...
*/
export function implementRnrsBase(plugins) {
...
*/
export function implementSchemeNumber(plugins) {
    "use strict";
...
export function makeMinimalBase() {
...
/*
    ...
    *fractionDigits* digits after the decimal point.
    ...
    Specified by: <ECMA-262, 5th edition at http://www.ecma-international.org/publications/standards/Ecma-262.htm>
 */
export function defineAbstractTypes(plugins) {
    "use strict";
    var g = plugins.get("es5globals");
    var api = g.Object.create(null);
    var SchemeNumberType = plugins.get("SchemeNumberType");
...
/*
    ...
    *Dispatch* are the same as those used in *plugins*, e.g.,
    ...
    "SchemeNumber".
*/
export function installAbstractTypes(plugins) {
    "use strict";
    var disp = plugins.get("Dispatch");
...
export function installStubFunctions(plugins) {
    "use strict";
    var g = plugins.get("es5globals");
    var uncurry = plugins.get("uncurry");
...
/*
    ...
    *s* should be the external representation of a Scheme number, such
    ...
    if false).
*/
export function implementPluginLibrary(plugins) {
    "use strict";
...
*/
export function installGenericFunctions(plugins) {
    "use strict";
...
*/
export function installEcmaMethods(plugins) {
    "use strict";
...
*/
export function installDefaultExactInteger(plugins, convert) {
    var ExactInteger = plugins.get("ExactInteger");
...
export function installDefaultRational(plugins, convert, divideReduced) {
    var ExactInteger = plugins.get("ExactInteger");
    var ExactRational = plugins.get("ExactRational");
...
*/
export function implementNativeInexactReal(plugins) {
    "use strict";
    var g = plugins.get("es5globals");
    var uncurry = plugins.get("uncurry");
    var InexactReal = plugins.get("InexactReal");
...
export function implementPrimitiveInexactReal(plugins) {
    "use strict";
    var g = plugins.get("es5globals");
    var uncurry = plugins.get("uncurry");
    var api = g.Object.create(null);
...
*/
export function implementNativeFlonumLibrary(plugins) {
    "use strict";
    var g = plugins.get("es5globals");
    var uncurry = plugins.get("uncurry");
    var api = g.Object.create(null);
...
*/
export function installFlonum(plugins) {
    "use strict";
...
*/
export function implementBigInteger(plugins, BigInteger) {
    "use strict";
    var g                        = plugins.get("es5globals");
    var uncurry                  = plugins.get("uncurry");
...
*/
export function defaultRationalFactory(plugins) {
    "use strict";
    var ExactRational            = plugins.get("ExactRational");
    var g                        = plugins.get("es5globals");
    var uncurry                  = plugins.get("uncurry");
...
*/
export function implementRectangular(plugins) {
    "use strict";
    var Real          = plugins.get("Real");
    var Complex       = plugins.get("Complex");
    var g             = plugins.get("es5globals");
...
export function installRectangular(plugins) {
...
export function defaultIntegerFactory(plugins) {
...
export var SchemeNumber = configure({});
