...
export function CodeHintDialogBoxMorph(target, simple) {
...
export function (parentSelector, from, to, otherFromBlocks) {
    var block1, block2;
...
export function (type, category, spec) {
...
export function(selector, parent, numArgs) {
    numArgs = numArgs || 0;
    var param;
...
export function (parentSelector, index, from, to) {
...
export function(list, parentSelector, index) {
