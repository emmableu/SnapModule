...
export function HighlightDisplay(hintWarning) {
...
export function(block, attachPoint, callback, size) {
...
export function(parent, positionMorph, callback, attachPoint, size) {
