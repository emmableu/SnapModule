...
export function setHintsActive(active) {
...
export function Hint(root, from, to, hasCustom) {
    this.root = root;
    this.from = from;
    this.to = to;
...
export function(hint, scripts, map, postfix, color) {
...
export function(parent, color, scriptHighlight, callback, hasCustom) {
