...
export function extend(clazz, functionName, newFunction) {
...
export function onWorldLoaded() {

}

export function extendObject(object, functionName, newFunction) {
...
export function instanceOfAny(object, types) {
